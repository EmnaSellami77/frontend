...
const styles = {
  ...
  // Boutons d'action
  formActions: {
    margimport React, { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userStr) {
        ...
        user.notifications = formData.notifications;
      ...
      setErrorMessage(error.response?.data?.error || "Erreur lors de l'enregistrement");
          ...
          {activeTab === "profile" && (
            <div>
              ...
              <div style={styles.avatarSection}>
                ...
                {isEditing && (
                  <button type="button" style={styles.avatarButton} disabled={loading}>
                    <svg style={styles.avatarIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" />
                      <circle cx="12" cy="13" r="4" />
                    </svg>
